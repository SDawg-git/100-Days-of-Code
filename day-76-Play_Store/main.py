...
Original file is located at
    https://colab.research.google.com/drive/1S0pZo85Vy9U2Xn1tfu2RfMzzBXqhnIBT
...
pd.to_numeric(df_apps_clean["Price"].str.replace("$", ""))
...
scatter = px.scatter(category_merged_df, # data
                    x='App', # column name
                    y='Installs',
...
df_apps_clean['Price'] = pd.to_numeric(df_apps_clean['Price'])
df_apps_clean[df_apps_clean['Price'] > 0]['Price'].median()

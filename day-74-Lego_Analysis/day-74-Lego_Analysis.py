...
Original file is located at
    https://colab.research.google.com/drive/1AVo47xPRCh9eGLAclK9ymnRSQmoJwZCz
...
print(opaque.shape[0])

for i in df["is_trans"].unique():
    print(i, df[df["is_trans"] == i].shape[0])
...
sets_df[sets_df["year"] == 1949].shape[0]

...
Original file is located at
    https://colab.research.google.com/drive/19TQBdGHfSeOLgicWyHgjXvJZA3pr8DYs
...
data.PTRATIO.mean() #18.5 students

data.PRICE.mean() #22.5
...
sns.displot(data.PRICE, aspect=2)

"""#### Distance to Employment - Length of Commute 🚗"""

sns.displot(data.RM, aspect=2)

"""#### Number of Rooms"""

sns.displot(data.DIS, aspect=2)

"""#### Access to Highways 🛣"""

sns.displot(data.RAD, aspect=2)
...
print(f'Property estimate: ${dollar_est:.6}')
